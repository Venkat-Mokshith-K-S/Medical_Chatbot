...
# Make sure the NLTK tokenizer data is present. On a fresh deploy container
# this download hasn't happened yet, so we do it at startup instead of
# relying on it having been run manually in a Python shell.
...
if __name__ == '__main__':
    # host=0.0.0.0 so the app is reachable inside a container (Render,
    # Railway, Fly.io, Docker, etc). PORT is injected by most PaaS platforms;
